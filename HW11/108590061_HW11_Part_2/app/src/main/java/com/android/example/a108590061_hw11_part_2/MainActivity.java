package com.android.example.a108590061_hw11_part_2;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ACTION_UPDATE_NOTIFICATION = "com.android.example.a108590061_hw11_part_2.ACTION_UPDATE_NOTIFICATION";
    ...
    public void updateNotification() {
        ...
        notifyBuilder.setStyle(new NotificationCompat.InboxStyle()
                .addLine(getString(R.string.line_first))
                .addLine(getString(R.string.line_second))
                .addLine(getString(R.string.line_third))
                .addLine(getString(R.string.line_fourth))
                .addLine(getString(R.string.line_last))
                .setBigContentTitle(getString(R.string.notification_updated))
                .setSummaryText(getString(R.string.the_summary_line)));
